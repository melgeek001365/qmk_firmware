...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT( /* Base */
		...
		KC_LCTL,    KC_LGUI,         LM(1, MOD_LALT),           KC_SPC,                             KC_RALT, MO(1),   KC_RGUI,         KC_RCTL
	),
	[1] = LAYOUT( /* FN */
		...
		_______,             _______,        _______,  _______, _______, _______, NK_TOGG, _______, _______, KC_END,  KC_PGDN,         KC_VOLU,
		_______,    _______, _______,                           TO(4),                              _______, _______, KC_MPRV,         KC_VOLD
	)
};
