...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_LAYER1] = LAYOUT( /* FN */
		    ...
		    KC_TRNS,            KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_INS,   KC_HOME,         KC_PGUP,  KC_TRNS,           \
		    KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_DEL,   KC_END,   KC_PGDOWN,       KC_TRNS,  KC_TRNS,  KC_TRNS, \
			KC_TRNS,            KC_TRNS,  KC_TRNS,                      KC_TRNS,                                KC_TRNS,  KC_TRNS,         KC_TRNS,  KC_TRNS,  KC_TRNS),
		[_LAYER2] = LAYOUT( /* LIGHT */
			KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_MNXT,  KC_MPRV,  KC_MPLY,  KC_CALC,         KC_MYCM,  KC_TRNS,  KC_TRNS, \
